...
import com.oy.shared.lm.in.WSDLtoGRAPH;
import com.oy.shared.lm.out.GRAPHtoDOTtoGIF;

public class WSDLtoGIFTask extends BaseTask {
 	
	public void processInFile() throws Exception {    	
   		assertFileName(options.inFile, "XML Web-Services (WSDL) file");
		IGraphModel graph = WSDLtoGRAPH.load(options);
