...
import com.oy.shared.lm.in.OJBtoGRAPH;
import com.oy.shared.lm.out.GRAPHtoDOTtoGIF;

public class OJBtoGIFTask extends BaseTask {
 	
	public void processInFile() throws Exception {    	
		assertFileName(options.inFile, "Object-Relation Bridge mapping file");
		IGraphModel graph = OJBtoGRAPH.load(options);    	
